...
import { getCategoryMetaTags, getSearchMetaTags } from "../config/meta";
...
const Tags: React.FC = () => {
    ...
    const { usePackagesByTag, tags } = useTag();
    const {
        filteredPackages,
        isLoading,
        error,
    ...
    const activeCategory = tags.find((cat) => cat.id === Number(id));
    useEffect(() => {
    ...
    return (
        <>
            ...
            {!searchName && activeCategory && (
                <Meta
                    config={getCategoryMetaTags(activeCategory?.name ?? "")}
                />
            )}
                    ...
                    <Breadcrumb
                        paths={[
                            ...
                            },
                            {
                                ...
                                url: `/tags/${activeCategory.id}/packages`,
                            },
                        ]}
                    />
                )}
