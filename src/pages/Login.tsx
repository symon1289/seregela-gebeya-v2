                        ...
                        <form className="space-y-6" onSubmit={handleSendOTP}>
                            ...
                            <div>
                                <button
                                    ...
                                    className="flex justify-center w-full px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md shadow-sm bg-septenary tracking-wider hover:bg-white hover:text-septenary border-septenary transition-colors duration-300 disabled:cursor-not-allowed disabled:opacity-50 focus:ring-offset-2 focus:ring-4 focus:outline-none focus:ring-primary "
                                >
                                    {isLoading ? (
