...
import abay from "../../assets/abay-for-payment.png";
...
const Abay: React.FC = () => {
    ...
    const checkOrder = async () => {
        ...
        if (data?.invoice?.abay_payment_transaction_no) {
