          ...
          <div className="bg-white rounded-lg py-4 shadow-sm  space-y-4">
            <div className="relative aspect-square">
              ...
              >
                <img
                  src={
                    packageItem.image_paths?.[selectedImageIndex] ||
                    defaultImage
                  }
            ...
            {packageItem.image_paths?.length > 1 && (
              <div className="flex gap-2 overflow-x-auto">
                {packageItem.image_paths?.map((image, index) => (
                  <button
                    key={index}
                  ...
                  onClick={() => {
                    dispatch(
                      toggleWishlistItem({
                        ...
                        name: packageItem.name,
                        price: String(packageItem.price),
                        image_paths: packageItem.image_paths || [],
                        left_in_stock: packageItem.left_in_stock,
                        quantity: 1,
                      })
                    );
                ...
                <>
                  <span className="text-lg text-gray-500 line-through">
                    {(
                      ...
                      (1 + parseFloat(packageItem.discount) / 100)
                    ).toFixed(2)}{" "}
                    {t("birr")}
                  </span>
