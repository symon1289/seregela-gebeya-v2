...
const DeliveryAddressForm: React.FC = () => {
    ...
    const [selectedDeliveryType_id, setSelectedDeliveryType_id] =
        useState<number>(0);
    ...
    const handleSubmit = () => {
        if (
            ...
            dispatch(saveDeliveryTypeID(selectedDeliveryType_id));
    ...
    return (
        <>
            <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                <div className="mt-4 md:-mt-5 space-y-3 rounded-lg  border   bg-white px-2 py-4 sm:px-6">
                            ...
                            deliveryTypes?.map((item) => (
                                ...
                                >
                                    <input
                                        ...
                                        value={item.id}
                                        onChange={() => {
                                            setSelectedDeliveryType_id(item.id);
                                            setSelectedDeliveryType(item);
                                            dispatch(saveDeliveryType(item));
                                            dispatch(
                                                saveDeliveryTypeID(item.id)
                                            );
                                        }}
                                        checked={
                                            selectedDeliveryType_id === item.id
                                        }
                                    />
                ...
                <button
                    ...
                    disabled={selectedDeliveryType_id === 0 || !locationClicked}
                >
                    {t("place_order")}
                </button>
            </div>
