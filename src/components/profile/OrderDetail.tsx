...
import OrderDetailkeleton from "../loading skeletons/order/OrderDetailkeleton";
                        ...
                        <div className="w-full justify-center items-start ">
                            <div className="w-full hidden md:grid grid-cols-2 p-4 bg-gray-50">
                                ...
                                <p className="flex items-center justify-between">
                                    ...
                                    <span className="w-full max-w-[300px] text-end px-8 text-gray-500 text-base font-normal leading-relaxed ">
                                        {t("price")}
                                    </span>
                                </p>
                            </div>
                            ...
                            {order &&
                                order.packages.map((product: any) => (
                                    <div
                                        key={product.id}
                                        className="grid grid-cols-1 md:grid-cols-2 min-[550px]:gap-6 py-3 border-b border-gray-200 max-sm:max-w-xl max-xl:mx-auto"
                                    >
